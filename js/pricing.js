/**
 * Black Rabbit / Cut My Grass pricing — working math, human override always.
 * Source of truth: pricing-algorithm.md
 */
(function (global) {
  function calculateLawnPrices(lotSqft, houseSqft, bags) {
  ...
  global.BRPricing = { calculateLawnPrices, formatMoney };
})(window);
